...
test("liquidity base tokens", () => {
  expect(liquidityForBaseQty(0.01, BigNumber.from(10000)).toNumber()).toBe(100)
  // Rounds down
  expect(liquidityForBaseQty(0.01075, BigNumber.from(9998)).toNumber()).toBe(107)
});

test("liquidity quote tokens", () => {
  expect(liquidityForQuoteQty(0.01, BigNumber.from(50)).toNumber()).toBe(5000)
  // Rounds down
  expect(liquidityForQuoteQty(109, BigNumber.from(9999)).toNumber()).toBe(91)
});
